...
public:
    ...
    Windows::Foundation::IAsyncOperation<MainInterfaceAutonomousResult^>^ AutonomousAsync();
    // Call the Backward method
    Windows::Foundation::IAsyncOperation<MainInterfaceBackwardResult^>^ BackwardAsync();
    // Call the Forward method
    Windows::Foundation::IAsyncOperation<MainInterfaceForwardResult^>^ ForwardAsync();
    // Call the Left method
    Windows::Foundation::IAsyncOperation<MainInterfaceLeftResult^>^ LeftAsync();
    // Call the Manual method
    Windows::Foundation::IAsyncOperation<MainInterfaceManualResult^>^ ManualAsync();
    // Call the Right method
    Windows::Foundation::IAsyncOperation<MainInterfaceRightResult^>^ RightAsync();
    // Call the Stop method
    Windows::Foundation::IAsyncOperation<MainInterfaceStopResult^>^ StopAsync();
