...
IAsyncOperation<MainInterfaceAutonomousResult^>^ MainInterfaceConsumer::AutonomousAsync()
{
    return create_async([this]() -> MainInterfaceAutonomousResult^
    {
        ...
        if (ER_OK == status)
        {
            status = alljoyn_proxybusobject_methodcall(
                ProxyBusObject,
                "com.glovebox.rover.RPIROBOTAllJoyn.MainInterface",
                "Autonomous",
                inputs,
                argCount,
                message,
...
IAsyncOperation<MainInterfaceBackwardResult^>^ MainInterfaceConsumer::BackwardAsync()
{
    return create_async([this]() -> MainInterfaceBackwardResult^
    {
...
IAsyncOperation<MainInterfaceForwardResult^>^ MainInterfaceConsumer::ForwardAsync()
{
    return create_async([this]() -> MainInterfaceForwardResult^
    {
...
IAsyncOperation<MainInterfaceLeftResult^>^ MainInterfaceConsumer::LeftAsync()
{
    return create_async([this]() -> MainInterfaceLeftResult^
    {
...
IAsyncOperation<MainInterfaceManualResult^>^ MainInterfaceConsumer::ManualAsync()
{
    return create_async([this]() -> MainInterfaceManualResult^
    {
...
IAsyncOperation<MainInterfaceRightResult^>^ MainInterfaceConsumer::RightAsync()
{
    return create_async([this]() -> MainInterfaceRightResult^
    {
...
IAsyncOperation<MainInterfaceStopResult^>^ MainInterfaceConsumer::StopAsync()
{
    return create_async([this]() -> MainInterfaceStopResult^
    {
...
int32 MainInterfaceConsumer::JoinSession(_In_ AllJoynServiceInfo^ serviceInfo)
{
    ...
    alljoyn_interfacedescription description = alljoyn_busattachment_getinterface(m_nativeBusAttachment, "com.glovebox.rover.RPIROBOTAllJoyn.MainInterface");
