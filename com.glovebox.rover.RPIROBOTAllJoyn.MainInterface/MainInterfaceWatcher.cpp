...
void MainInterfaceWatcher::UnregisterFromBus()
{
    ...
    {
        PCSTR interfaces[] = { "com.glovebox.rover.RPIROBOTAllJoyn.MainInterface" };
    ...
    _In_ const alljoyn_msgarg aboutDataArg)
{
    ...
    if (alljoyn_aboutobjectdescription_hasinterface(objectDescription, "com.glovebox.rover.RPIROBOTAllJoyn.MainInterface"))
    {
        AllJoynServiceInfo^ args = ref new AllJoynServiceInfo(
            AllJoynHelpers::MultibyteToPlatformString(name),
            AllJoynHelpers::GetObjectPath(objectDescription, "com.glovebox.rover.RPIROBOTAllJoyn.MainInterface"),
            port);
        Added(this, args);
    }
